...
#define TFL_LENGTH_COLOR                    5000
	...
	*/
	...
	/// @return Unified processing result
	*/
	extern "C" TFL_RESULT TFL_DLL		MarkPCDNoise(TFL_PointXYZ pcdFullBuf[TFL_FRAME_SIZE], uint16_t sensitiveFactor, bool noiseFlags[TFL_FRAME_SIZE], uint16_t & out_countNoise);
